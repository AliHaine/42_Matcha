...
CREATE TABLE users (
    ...
    CONSTRAINT weight_invalid CHECK (weight IN ('< 50', '51-60', '61-70', '70-80', '80-90', '90-100', '> 100')),
    CONSTRAINT height_invalid CHECK (height IN ('< 150', '151-160', '161-170', '171-180', '181-190', '191-200', '> 200')),
