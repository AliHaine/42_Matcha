...
connection = psycopg2.connect(database="matcha", user="admin", password="admin/0123456789", host="localhost", port=5432)
cursor = connection.cursor()

link = "https://randomuser.me/api/?nat=fr&inc=name,dob,gender&results="

def populate_cities():
    city_link = "https://geo.api.gouv.fr/communes?limit=100000&fields=nom,code,departement,region,centre,population,codesPostaux"
    ...
    query = """
        UPDATE cities
        SET citycode = %s, departementname = %s, departementcode = %s, regionname = %s, regioncode = %s, centerlon = %s, centerlat = %s
        WHERE cityname = %s;
        """
